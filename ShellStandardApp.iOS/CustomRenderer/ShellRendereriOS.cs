...
using ShellStandardApp.iOS.CustomRenderer.LonginesEquestrianApp.iOS.CustomRenderer;
using UIKit;
using Xamarin.Forms;
			...
			public override async void SetAppearance(UITabBarController controller, ShellAppearance appearance)
			{
				...
				if (controller.TabBar.Items != null)
				{
					foreach (UITabBarItem tabbaritem in controller.TabBar.Items)
					{
						...
						//var svgImageSource = SvgImageSource.FromResource("resource://LonginesEquestrianApp.SVGResources.LoginPage.appleicon.svg");
